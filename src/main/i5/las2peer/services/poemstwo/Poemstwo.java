 ...
 *
 */
@ServicePath("poemstwo")
@ManualDeployment
public class Poemstwo extends RESTService {
  ...
  public static class RootResource {
    ...
    private final Poemstwo service = (Poemstwo) Context.getCurrent().getService();
  ...
  @ApiOperation(value = "getpeosmtwo", notes = " ")
  public Response getpeosmtwo() {
